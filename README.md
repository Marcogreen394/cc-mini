...
> /buddy ia           # Start Idle Adventure (see below)
```
...
### Idle Adventure — Buddy
> Enter `/buddy ia` to let your buddy step into the World of the Source Tree! Fully automatic idle adventure, collect tickets and draw 30 legendary badges.

- **Idle Adventure** — Buddy automatically explores six major regions, battles monsters and triggers random events, all you need to do is watch
- **Ticket Economy** — Earn tickets through adventures, which can be used to draw badge fragments via gacha (guaranteed rewards for single draw / ten consecutive draws)
- **30 Badges** — Four rarity levels (Common / Precious / Rare / Legendary), collect all of them to awaken the Source Tree
- **Attribute Growth** — Badges provide permanent attribute bonuses, making each adventure more powerful
- **Terminal TUI** — Full-screen fixed interface, operated with arrow keys, FC game-style main menu
---
